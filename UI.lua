...
local Library do
    ...
    Library = {
        ...
        Folders = {
            Directory = "LunaraHub",
            Configs = "LunaraHub/Configs",
            Assets = "LunaraHub/Assets",
            Themes = "LunaraHub/Themes"
        },
    ...
    Library.NotifHolder = Instances:Create("Frame", {
        ...
        Name = "\0",
        BackgroundTransparency = 1,
        Position = UDim2New(0, 20, 0, 70),
        Size = UDim2New(0, 0, 1, -90),
        BorderSizePixel = 0,
    ...
    Library.Notification = function(self, Text, Description, Duration)
        local Items = { } do
            Items["Notification"] = Instances:Create("Frame", {
                ...
                BackgroundColor3 = FromRGB(13, 13, 20)
            ...
            Items["NotifAccent"] = Instances:Create("Frame", {
                Parent = Items["Notification"].Instance,
            ...
            Instances:Create("UICorner", {
                Parent = Items["NotifAccent"].Instance,
    ...
    Library.CreateColorpicker = function(self, Data)
        ...
        local Items = { } do
            ...
            Items["ColorpickerWindow"] = Instances:Create("Frame", {
                ...
                Visible = false,
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(10, 10, 15)
        ...
        local SetRainbow = function(Bool)
            ...
            if IsRainbow then 
                ...
                Items["Shadow"]:Tween(nil, {ImageTransparency = 0.4})
    ...
    Library.Window = function(self, Data)
        ...
        local Items = { } do
            ...
            Items["Shadow2"] = Instances:Create("ImageLabel", {
                ...
                ScaleType = Enum.ScaleType.Slice,
                Name = "\0",
                ImageTransparency = 0.6800000286102295,
                BorderColor3 = FromRGB(0, 0, 0),
                BackgroundColor3 = FromRGB(255, 255, 255),
            ...
            Instances:Create("Frame", {
                ...
                ZIndex = 2,
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(25, 25, 35)
            ...
            Items["Inline"] = Instances:Create("Frame", {
                ...
                Name = "\0",
                BackgroundTransparency = 1,
                Position = UDim2New(0, 79, 0, 0),
                Size = UDim2New(1, -79, 1, 0),
                ZIndex = 2,
    ...
    Library.Page = function(self, Data)
        ...
        local Items = { } do
            ...
            Items["Inactive"]:OnHover(function()
                Items["Inactive"]:Tween(nil, {ImageTransparency = 0.25})
            end)
    ...
    Library.Sections.Button = function(self, Data)
        ...
        function Button:Press()
            ...
            Items["Button"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Library.Theme.Accent})
            Items["UIStroke"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Color = Library.Theme["Light Accent"]})
            ...
            Items["Button"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Library.Theme.Element})
            Items["UIStroke"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Color = Library.Theme.Border})
